...
public class CreateRequest {
	...
	public void createRequest(Exchange exchange) throws Exception {
		...
		// SapSynchronousRfcDestinationEndpoint endpoint = exchange.getContext().getEndpoint("sap-srfc-destination:quickstartDest:ZBAPI_FLCUST_GETLIST", SapSynchronousRfcDestinationEndpoint.class);
		...
		String customerName = exchange.getMessage().getHeader("name", String.class);
		
		// Add query parameters to the request to retrieve up to 100 Customer records including Web Users.
